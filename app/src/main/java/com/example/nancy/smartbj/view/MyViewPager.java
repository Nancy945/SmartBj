 ...
 *
 * 这是一个老版本ViewPager的源代码，唯一的不同是修改了默认的两侧加载数量为0（也就是不缓存，或者称为懒加载）
 */
public class MyViewPager extends ViewGroup {
    ...
    private static final int DEFAULT_OFFSCREEN_PAGES = 0; //todo 将这里从1修改到了0.默认的加载页面,ViewPager是1个,所以会加载两个Fragment
